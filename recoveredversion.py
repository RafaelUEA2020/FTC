...
def q24():
    global list1, list2, head1, head2, tape2, tape1
    print(ACEITA)
...
def main():
    ...
    tape1 = input('').upper()  # lê a entrada e converte para minúsculas
    tape1 = 'b' + tape1 + 'b'  # adiciona branco no início e no fim da fita
    tape2 = tape1
    list1 = list(tape1)
    list2 = list(tape2)
    head1 = 0
